...
//   // ✅ Safely parse the movie show date
//   DateTime? parseMovieDate(String dateStr) {
//     try {
//       if (dateStr.isEmpty) return null;
//       return DateFormat("yyyy-MM-dd").parse(dateStr);
...
//             crossAxisCount: 2,
//             crossAxisSpacing: 14,
//             mainAxisSpacing: 2, // slightly less
//             childAspectRatio: 0.63, // slightly less
//           ),
...
//                         // setState(() { ... filter movies ... });
//                       },
//                       style: const TextStyle(color: Colors.white),
//                       decoration: InputDecoration(
//                         hintText: 'Search movies...',
//                         hintStyle: TextStyle(
//                           color: const Color.fromARGB(255, 40, 242, 14),
//                         ),
//                         prefixIcon: const Icon(
//                           Icons.search,
//                           color: Color.fromARGB(255, 107, 246, 48),
...
//                           borderRadius: BorderRadius.circular(12),
//                           borderSide: const BorderSide(
//                             color: Color.fromARGB(255, 130, 243, 18), // ✅ correct placement
//                             width: 1.5,
//                           ),
//                         ),
